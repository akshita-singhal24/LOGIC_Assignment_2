...
// Command Line Options: /compile:3 /compileTarget:cs /spillTargetCode:3 task4.dfy
// task4.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      BigInteger _5_t0;
      BigInteger _out0;
      _out0 = __default.Tribonacci(BigInteger.Zero);
      _5_t0 = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("T(0) = ")));
      Dafny.Helpers.Print((_5_t0));
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("\n")));
      BigInteger _6_t1;
      BigInteger _out1;
      _out1 = __default.Tribonacci(BigInteger.One);
      _6_t1 = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("T(1) = ")));
      Dafny.Helpers.Print((_6_t1));
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("\n")));
      BigInteger _7_t2;
      BigInteger _out2;
      _out2 = __default.Tribonacci(new BigInteger(2));
      _7_t2 = _out2;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("T(2) = ")));
      Dafny.Helpers.Print((_7_t2));
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("\n")));
      BigInteger _8_t3;
      BigInteger _out3;
      _out3 = __default.Tribonacci(new BigInteger(3));
      _8_t3 = _out3;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("T(3) = ")));
      Dafny.Helpers.Print((_8_t3));
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("\n")));
      BigInteger _9_t4;
      BigInteger _out4;
      _out4 = __default.Tribonacci(new BigInteger(4));
      _9_t4 = _out4;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("T(4) = ")));
      Dafny.Helpers.Print((_9_t4));
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("\n")));
      BigInteger _10_t5;
      BigInteger _out5;
      _out5 = __default.Tribonacci(new BigInteger(5));
      _10_t5 = _out5;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("T(5) = ")));
      Dafny.Helpers.Print((_10_t5));
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString("\n")));
    }
  }
